...
| --- | --- | --- |
| Off-chain domain model, ownership accounting, state machines | **PASS** | `npm test` — 260 tests, 37 suites, 0 failures |
...
320 tests pass across three independent layers: 260 TypeScript domain tests, 31 Rust unit tests and 29 Anchor
...
```bash
npm install
npm test              # 260 TypeScript tests, 37 suites
